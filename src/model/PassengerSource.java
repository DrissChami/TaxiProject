...
/**
 * Periodically generate passengers. Keep track of the number of passengers for
 * whom a vehicle cannot be found.
 * 
...
public class PassengerSource implements Actor {
	 ...
	 * 
	 * @param company
	 *            The company to be used. Must not be null.
	...
	/**
	 * @return The number of passengers for whom a pickup could not be found.
	 */
	...
	/**
	 * Create a new passenger with distinct pickup and destination locations.
	 * 
