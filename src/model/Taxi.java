...
public class Taxi extends Vehicle implements DrawableItem {
	...
	public Taxi(TaxiCompany company, Location location) {
		...
		// Load the two images.
		emptyImage = new ImageIcon(getClass().getResource("/images/taxi.jpg"))
				.getImage();
	...
	public Taxi(TaxiCompany company, Location location, String taxiName) {
		super(company, location, taxiName);
		// Load the two images.
		emptyImage = new ImageIcon(getClass().getResource("/images/taxi.jpg"))
				.getImage();
		passengerImage = new ImageIcon(getClass().getResource(
